...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='other@example.com', password='passwird123')
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='asd@example.com', password='pass123')
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        ...
        new_user = create_user(email='asdf@example.com', password='pass123')
    ...
    def test_create_tag_on_update(self):
        """Test creating tag when updatking a recipe"""
        recipe = create_recipe(user=self.user)
